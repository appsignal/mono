  ...
  context "with Elixir project" do
    ...
    context "with mono repo" do
      ...
      context "with only one package selected" do
        it "only builds the selected package" do
          prepare_project :elixir_mono
          output =
            capture_stdout do
              in_project do
                run_build(["--package", "package_one"])
              end
            end
      ...
      context "with multiple packages selected" do
        it "builds the selected packages" do
          ...
          output =
            capture_stdout do
              in_project do
                run_build(["--package", "package_one,package_two"])
              end
            end
      ...
      context "with unknown packages selected" do
        it "exits with an error" do
          ...
          output =
            capture_stdout do
              in_project do
                run_build(["--package", "package_one,package_three"])
              end
            end
